...
ataqueHorda zombies protagonista = foldr ($) protagonista (map (reaccion protagonista) zombies)
...
Resultado: Protagonista {nombre = "Maggie", vida = -5, reaccion = <function>, seresQueridos
 = [Protagonista {nombre = "Carol", vida = 35, reaccion = <function>, seresQueri
dos = [Protagonista {nombre = "Victor Sueiro", vida = 1, reaccion = <function>,
seresQueridos = []}]},Protagonista {nombre = "Daryl", vida = -2, reaccion = <fun
ction>, seresQueridos = [Protagonista {nombre = "Carol", vida = 200, reaccion =
<function>, seresQueridos = [Protagonista {nombre = "Victor Sueiro", vida = 1, r
eaccion = <function>, seresQueridos = []}]}]},Protagonista {nombre = "Krilin", v
ida = -15, reaccion = <function>, seresQueridos = []}]}
